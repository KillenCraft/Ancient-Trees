## Kore Sample
**LATEST OFFICIAL VERSION**: [Kore Sample 1.1.0 for MC 1.7.10][release] ([changelog][changelog.md])
[release]: https://github.com/MinecraftModArchive/KoreSample/releases/download/v1.1.0/KoreSample-1.7.10-1.1.0.jar
