...
public final class ModBlocks
{
    ...
    private static final ImmutableList<? extends WorldGenerator> SAPLING0_GENS = ImmutableList.of(new Beech(true), new Cedar(true), new Cherry(true), new Cypress(true), new WorldGenTaiga1(), new WorldGenTaiga1(), new WorldGenTaiga1(), new WorldGenTaiga1());
