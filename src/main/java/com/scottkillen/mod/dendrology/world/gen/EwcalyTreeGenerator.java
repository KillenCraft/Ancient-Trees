...
public enum EwcalyTreeGenerator implements IWorldGenerator
{
    INSTANCE;
    ...
    {
        if (!Settings.TreeGen.doEwcalyTreeGeneration()) return;
    ...
    private static boolean isIdealHabitat(ImmutableSet<BiomeDictionary.Type> biomeTags) {
        return !biomeTags.contains(COLD) || biomeTags.contains(JUNGLE);
    }
