...
public enum KulistTreeGenerator implements IWorldGenerator
{
    INSTANCE;
    ...
    private static boolean isIdealHabitat(ImmutableSet<BiomeDictionary.Type> biomeTags) {
        return (biomeTags.contains(PLAINS) || biomeTags.contains(BEACH) || biomeTags.contains(WATER)) && !biomeTags.contains(WET);
    }
